...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <nav className={`global-nav ${isHomePage ? "hide-on-mobile" : ""}`}>
        <div className="nav-container">
          ...
          <div className="nav-links" id="nav-links">
            <Link
              to="/hero-database"
              className={`nav-link nav-link-main ${isActive("/hero-database") ? "active" : ""
                }`}
            ...
            <Link
              to="/guild-war-teams"
              className={`nav-link nav-link-external ${isActive("/guild-war-teams") ? "active" : ""
                }`}
              onClick={() => setMenuOpen(false)}
            >
              <svg
            ...
            <Link
              to="/speed-gearing"
              className={`nav-link nav-link-external ${isActive("/speed-gearing") ? "active" : ""
                }`}
              onClick={() => setMenuOpen(false)}
            >
              <svg
            ...
            <Link
              to="/wish-list"
              className={`nav-link nav-link-external ${isActive("/wish-list") ? "active" : ""
                }`}
              onClick={() => setMenuOpen(false)}
            >
              <svg
            ...
            <Link
              to="/team-builder"
              className={`nav-link nav-link-external ${isActive("/team-builder") ? "active" : ""
                }`}
              onClick={() => setMenuOpen(false)}
            >
              <svg
